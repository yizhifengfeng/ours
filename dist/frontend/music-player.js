...
(function () {
    ...
    function checkAdmin() {
        ...
        return fetch((window.API_BASE_URL || '') + '/api/admin/me', {
    ...
    function fetchCurrentMusicMeta() {
        return fetch((window.API_BASE_URL || '') + '/api/music-current')
    ...
    function uploadMusicToCloud(file) {
        ...
        return fetch(apiBase + '/api/music-upload-sign', {
            ...
            return fetch(apiBase + '/api/music-tracks', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: 'Bearer ' + getAdminToken()
            ...
            return fetch(apiBase + '/api/music-current', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: 'Bearer ' + getAdminToken()
